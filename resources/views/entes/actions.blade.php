<td>
    <div class='btn-list'>
        <a href="{{ route('entes.edit', $id) }}" class='btn btn-info' data-bs-toggle="tooltip"
           data-bs-placement="top" title="Editar">
            <span>Editar</span>
        </a>

        <form action="{{ route('entes.destroy', $id) }}" method="POST" class="btn-delete" style="display:inline;">
            @csrf
            @method('DELETE')
