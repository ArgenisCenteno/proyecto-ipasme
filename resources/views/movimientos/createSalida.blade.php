                    ...
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-auto ms-auto">
                            <div class="btn-list">
                                ...
                                <a href="{{route('salidas.index')}}" class="btn btn-secondary d-none d-sm-inline-block">
                ...
                <div class="container-xl">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title mb-4">Datos de la salida</h3>
                                   
                                    @include('movimientos.fields_salidas')
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title mb-4">Bienes</h3>
                                     @include('movimientos.datatableProductosSalidas')
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title mb-4">Bienes seleccionados</h3>
                                     @include('movimientos.carritoSalidas')
                                </div>
                            </div>
                        </div>
                    </div>
