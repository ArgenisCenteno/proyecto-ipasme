<td>
    <div class='btn-list'>
        <a href="{{ route('bienes.editar', $id) }}" class='btn btn-info' data-bs-toggle="tooltip"
           data-bs-placement="top" title="Editar">
            <span>Editar</span>
        </a>

        <form action="{{ route('bienes.destroy', $id) }}" method="POST" class="btn-delete" style="display:inline;">
            @csrf
            @method('DELETE')
